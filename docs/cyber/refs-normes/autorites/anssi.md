...
```mermaid
graph LR
    A[Direction Générale<br/>ANSSI]
    
    B[Direction des<br/>Opérations]
    C[Direction de la<br/>Stratégie]
    D[Direction de la<br/>Réglementation]
    E[Direction de<br/>l'Expertise]
    F[Direction des<br/>Technologies]
    ...
    B --> B1[CERT-FR<br/>Réponse aux incidents]
    B --> B2[Centre de<br/>Détection OPERA]
    B --> B3[Gestion de crise]
    
    C --> C1[Veille stratégique]
    C --> C2[Relations<br/>internationales]
    C --> C3[Sensibilisation]
    
    D --> D1[Référentiels<br/>réglementaires]
    D --> D2[Homologations]
    D --> D3[Qualifications]
    
    E --> E1[Évaluation<br/>produits]
    E --> E2[Audits techniques]
    E --> E3[Recherche]
    
    F --> F1[Cryptographie]
    F --> F2[Sécurité matérielle]
    F --> F3[Innovation]
...
```mermaid
graph LR
    A[OIV identifié] --> B[Désignation d'un RSSI]
    B --> C[Déclaration des<br/>systèmes d'information<br/>d'importance vitale SIIV]
    C --> D[Mise en œuvre de<br/>mesures de sécurité]
    D --> E[Audits réguliers<br/>par l'ANSSI]
    E --> F[Déclaration des<br/>incidents significatifs]
    F --> G[Contrôles de conformité]
...
```mermaid
graph TB
    A[cyber.gouv.fr] --> B[Publications]
    A --> C[Règlementation]
    A --> D[Services]
    A --> E[Actualités]
    
    B --> B1[Guides techniques]
    B --> B2[Bonnes pratiques]
    B --> B3[Rapports annuels]
    B --> B4[Notes d'information]
    
    C --> C1[Référentiels<br/>RGS, PSSIE]
    C --> C2[Obligations légales<br/>LPM, NIS]
    C --> C3[Certifications]
    
    D --> D1[Qualification de<br/>produits et prestataires]
    D --> D2[CERT-FR]
    D --> D3[Signalement d'incident]
    
    E --> E1[Bulletins d'actualité]
    E --> E2[Alertes de sécurité]
    E --> E3[Événements]
...
```mermaid
graph LR
    A[Demande de<br/>qualification] --> B[Dossier de<br/>candidature]
    B --> C[Évaluation technique<br/>par l'ANSSI]
    C --> D{Conformité ?}
    D -->|OUI| E[Qualification délivrée]
    D -->|NON| F[Demande de<br/>corrections]
    F --> C
    E --> G[Surveillance<br/>périodique]
...
graph TD
    ...
    D -->|OUI| E[Test du correctif<br/>en pré-production]
    D -->|NON| F[Mise en œuvre de<br/>mesures compensatoires]
    E --> G{Test<br/>concluant ?}
    G -->|OUI| H[Déploiement en<br/>production]
    G -->|NON| I[Analyse de<br/>compatibilité]
    I --> F
    F --> J[Surveillance renforcée]
    H --> K[Documentation et<br/>retour d'expérience]
    J --> K
...
graph TD
    ...
    C --> E[Mise en relation avec<br/>prestataire qualifié]
    D --> F[Analyse et assistance<br/>technique ANSSI]
    E --> G{Incident<br/>majeur ?}
    G -->|OUI| D
    G -->|NON| H[Résolution locale]
