---
description: "Le règlement européen encadrant les contrôleurs d'accès numériques (gatekeepers) pour garantir des marchés numériques équitables et contestables"
icon: lucide/book-open-check
tags: ["DMA", "GATEKEEPERS", "CONCURRENCE", "PLATEFORMES", "RÉGLEMENTATION", "EUROPE", "NUMÉRIQUE"]
---
...
---
timeline
    title Contexte et genèse du DMA
    2004 : Microsoft - Abus dominant
         : Windows et Windows Media Player
         : Amende 497M€
         : Procédure 5+ ans
    2017 : Google Shopping
         : Amende 2,4Md€
         : Procédure 7 ans
         : Résilience du dominant
    2018 : Google Android
         : Amende 4,3Md€
         : Comportement peu modifié
    2019 : Google AdSense
         : Amende 1,5Md€
         : Toujours dominant
    2020 : Rapport Vestager
         : Limites droit concurrence
         : Besoin régulation ex ante
    2022 : Adoption DMA
         : Règlement 2022/1925
         : Obligations contraignantes
    2023 : Application DMA
         : 2 mai 2023
...
mindmap
  root((DMA efficace))
    ...
    Interopérabilité
      ...
      APIs ouvertes
      Standards ouverts
    Équité vis-à-vis des tiers
      Pas d'avantage propre
    ...
    Portabilité des données
      Export utilisateurs
      Transfert vers concurrents
      Format interopérable
    Prohibition d'installations par défaut
