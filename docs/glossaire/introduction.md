---
description: "Guide du lecteur — structure, format et niveaux de lecture du Glossaire OmnyDocs."
icon: lucide/map
tags: ["GLOSSAIRE", "GUIDE", "INTRODUCTION"]
---
...
| Domaine | Contenu |
| --- | --- |
| **Bases Fondamentales** | Algorithmique, structures de données, programmation, architecture des systèmes |
...
Les termes ne sont pas explicitement classifiés par niveau, mais leur complexité suit logiquement la progression des domaines.

| Niveau | Description | Domaines typiques |
| --- | --- | --- |
| **Base** | Concepts fondamentaux accessibles sans prérequis | Bases fondamentales, premiers termes réseau |
| **Intermédiaire** | Nécessite des prérequis techniques de base | Administration système et réseau, Dev Web |
| **Avancé** | Concepts complexes pour profils spécialisés | Cloud, DevSecOps, Cybersécurité |
...
!!! tip "Recherche rapide"
    Utilisez le moteur de recherche intégré — raccourci clavier `Ctrl + K` — pour localiser directement un terme sans parcourir les sections une à une.

!!! info "Références croisées"
    Les schémas Mermaid dans chaque définition pointent vers des termes connexes. Si un terme référencé vous est inconnu, recherchez-le directement dans la section correspondante.
