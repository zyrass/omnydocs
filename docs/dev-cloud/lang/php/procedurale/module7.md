...
```sql
-- ============================================
-- BASE DE DONNÉES BLOG COMPLET
-- ============================================

CREATE DATABASE blog_final CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE blog_final;
...
CREATE TABLE posts (
    ...
    FULLTEXT idx_fulltext_search (title, content)
) ENGINE=InnoDB;
...
-- Table post_category (many-to-many)
...
### 8.2 Classes du Projet

Voir fichiers complets dans le dépôt (trop volumineux pour inclusion complète ici).
...
├── src/
│   ├── Database.php       # Singleton connexion
