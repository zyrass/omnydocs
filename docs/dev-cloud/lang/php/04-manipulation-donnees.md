...
!!! tip "Pratique Intensive — Projet 7"
    L'un des exercices les plus constructifs en PHP Procédural. Construire un CRUD, gérer une Session multidimensionnelle Array et effectuer des tris dynamiques au clic s'explore du côté Projets.
    
    👉 **[Aller au Projet 7 : Micro-CRM (CRUD et Sessions)](../../../../projets/php-lab/07-gestionnaire-contacts/index.md)**

---

### Exercice 2 : Validateur de Données Multiformats

!!! tip "Pratique Intensive — Projet 8"
    Regrouper les Expressions Régulières les plus célèbres, les filtres natifs et les valider dans un banc d'essai est la clé du Nettoyage et de la Sécurité Web !
    
    👉 **[Aller au Projet 8 : Laboratoire Regex et Validation](../../../../projets/php-lab/08-validateur-donnees/index.md)**
