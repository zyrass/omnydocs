...
### Exercice 1 : Blog avec Namespaces

**Créer structure blog complète avec namespaces PSR-4**
...
class PostRepository {
    ...
    private function hydrate(array $data): Post {
        $post = new Post($data['title'], $data['content'], (int)$data['author_id']);
...
### Exercice 2 : E-commerce Multi-Vendor

**Créer structure e-commerce avec plusieurs vendeurs**
...
namespace ECommerce\Services\Shipping;

namespace ECommerce\Repositories\Products;
namespace ECommerce\Repositories\Orders;

namespace ECommerce\Controllers\Admin;
namespace ECommerce\Controllers\Vendor;
