...
!!! tip "Pratique Intensive — Projet 20"
    Associez la puissance du mot-clé `match` (PHP 8) à l'Héritage Horizontal pour envoyer des E-mails, des SMS et des Pushs Mobile depuis la même Classe User !
    
    👉 **[Aller au Projet 20 : Système de Notifications](../../../../projets/php-lab/20-systeme-notifications/index.md)**

### Exercice 2 : Query Builder avec Traits
    
!!! tip "Pratique Intensive — Projet 21"
    Bâtissez une Fondation d'Outil ORM Modulaire : Le `WHERE`, le `LIMIT` et le `SELECT` sont éclatés dans différents *Traits* et assemblés mathématiquement pour générer une chaine SQL !
    
    👉 **[Aller au Projet 21 : Query Builder SQL](../../../../projets/php-lab/21-query-builder/index.md)**
