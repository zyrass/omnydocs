...
!!! tip "Pratique Intensive — Projet 25"
    Créez une Collection de Données qui possède à la fois les super-pouvoirs d'un Tableau PHP classique `[]` et ceux d'un Objet `->`.
    
    👉 **[Aller au Projet 25 : Collection Magique](../../../../projets/php-lab/25-collection-magique/index.md)**

### Exercice 2 : Builder Pattern avec __call
    
!!! tip "Pratique Intensive — Projet 26"
    Décollez le capot d'une "MagicQueryBuilder" en usurpant la fonction native `__call` afin de générer dynamiquement vos requêtes de base de données depuis des méthodes fantômes !
    
    👉 **[Aller au Projet 26 : Query Builder Magique](../../../../projets/php-lab/26-builder-magique/index.md)**
