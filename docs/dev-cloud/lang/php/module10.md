...
!!! tip "Pratique Intensive — Projet 18"
    Maîtrisez l'Injection de Dépendance en créant un Service de Stockage (RAM et Disque Dur Local) orchestré par une Interface stricte !
    
    👉 **[Aller au Projet 18 : Système de Stockage](../../../../projets/php-lab/18-systeme-stockage/index.md)**

### Exercice 2 : Validation System
    
!!! tip "Pratique Intensive — Projet 19"
    Achevez de comprendre les Interfaces en développant un Validateur Universel fonctionnant avec des Règles Extensibles en isolation (Principe Open-Closed).
    
    👉 **[Aller au Projet 19 : Système de Validation](../../../../projets/php-lab/19-systeme-validation/index.md)**
