...
!!! tip "Pratique Intensive — Projet 9"
    Oubliez les tutos obsolètes de 2012. Construire de zéro un mur de sécurité avec Headers HTTP, Filtres anti-Spam et Jetons cryptographiques CSRF, c'est ce que nous faisons dans le Lab.
    
    👉 **[Aller au Projet 9 : Formulaire de Contact Blindé](../../../../projets/php-lab/09-formulaire-securise/index.md)**

---

### Exercice 2 : Upload d'Avatar Sécurisé

!!! tip "Pratique Intensive — Projet 10"
    Gérer correctement `enctype="multipart/form-data"`, refuser les fausses extensions via le super-module `finfo_file` (MIME Type) et tuer les collisions de UUID est indispensable.
    
    👉 **[Aller au Projet 10 : Gestionnaire d'Upload Sécurisé (Avatar)](../../../../projets/php-lab/10-upload-avatar/index.md)**
