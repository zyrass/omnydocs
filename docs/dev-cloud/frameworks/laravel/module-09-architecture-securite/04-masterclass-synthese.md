...
```mermaid
graph TB
    subgraph "Niveau Expert (L'Excellence !)"
        E1[Architecte Solutions Entreprise]
    end
    
    subgraph "Niveau Senior (Intermédiaire +)"
        S1[TDD Maîtrisé et Test Unitaire]
        S2[APIs Complexes et Multi Token/Scopes]
        S3[DevOps CI/CD et Auto Deploy pipeline]
    end
    
    subgraph "Niveau Confirmé"
        I1[Les Queues & Jobs Redis]
        I2[Sanctum APIs Basics]
        I4[Testing Feature]
    end
    
    subgraph "Niveau Développeur (Votre Parcours validé)"
        J1[Eloquent Relations & Bases de Données]
        J2[Auth Custom & Breeze Kit]
        J3[Policies / Roles ]
        J4[Owasp Securité & Middlewares]
        J5[Frontend Tall Stack]
    end
