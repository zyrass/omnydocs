...
PARTS = [
    ...
    "config/toml/navigation/04-nav-cyber-governance.toml",
    "config/toml/navigation/05-nav-cyber-operations.toml",
    "config/toml/navigation/06-nav-cyber-tools.toml",
    "config/toml/navigation/07-nav-glossaire.toml",
    "config/toml/navigation/08-nav-projets.toml",
    "config/toml/navigation/09-nav-cursus-forensic.toml",
